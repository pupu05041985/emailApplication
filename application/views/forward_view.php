...
<?php //echo "<pre>";print_r($populate);echo "</pre>";?>
	   <div class="column-left"></div><?php //echo "<pre>";print_r($populate);echo "</pre>";?>
	   <div class="column-left"></div>
	   <div class="column-center"><?php //echo $msg;?><br>
	   <form action="../../forwardemail" method="post" enctype="multipart/form-data" style="margin-left: 74%;">
			Forward To: <br><input type="text" id="email" name="email"><br><br>
			Subject: <br><input type="text" id="subject" name="subject"  value="forward<?php echo $populate['subject']?>"><br><br>
			Body:<br><textarea rows="25" name="message" id="message" cols="50"><?php echo $populate['message']?></textarea><br><br>
